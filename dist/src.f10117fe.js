...
},{"_css_loader":"node_modules/parcel-bundler/src/builtins/css-loader.js"}],"node_modules/xstate/es/_virtual/_tslib.js":[function(require,module,exports) {
"use strict";
...
function raise(event, options) {
  return {
    ...
    event: typeof event === 'function' ? event : (0, _utils.toEventObject)(event),
...
function resolveActions(machine, currentState, currentContext, _event, actionBlocks, predictableExec, preserveActionOrder) {
    ...
    switch (actionObject.type) {
      ...
      case actionTypes.send:
        ...
        if (!_environment.IS_PRODUCTION) {
          ...
          (0, _utils.warn)(!(0, _utils.isString)(configuredDelay) || typeof sendAction.delay === 'number',
      ...
      case actionTypes.choose:
        {
          ...
          var _b = (0, _tslib.__read)(resolveActions(machine, currentState, updatedContext, _event, [{
              type: blockType,
              actions: toActionObjects((0, _utils.toArray)(matchedActions), machine.options.actions)
      ...
      case actionTypes.pure:
        {
          ...
          var _c = (0, _tslib.__read)(resolveActions(machine, currentState, updatedContext, _event, [{
              type: blockType,
              actions: toActionObjects((0, _utils.toArray)(matchedActions), machine.options.actions)
            }], predictableExec, preserveActionOrder), 2),
      ...
      default:
        ...
        if (predictableExec) {
          ...
          var wrapped = (0, _tslib.__assign)((0, _tslib.__assign)({}, resolvedActionObject), {
            exec: function (_ctx) {
              var args = [];
  ...
  function processBlock(block) {
    ...
    var resolvedActions = [];
    try {
      for (var _b = (0, _tslib.__values)(block.actions), _c = _b.next(); !_c.done; _c = _b.next()) {
        var action = _c.value;
...
function () {
  ...
  function Interpreter(machine, options) {
    ...
    this.sendTo = function (event, to, immediate) {
      ...
      var target = isParent ? _this.parent : (0, _utils.isString)(to) ? to === _types.SpecialTargets.Internal ? _this : _this.children.get(to) || _registry.registry.get(to) : (0, _utils.isActor)(to) ? to : undefined;
      if (!target) {
        if (!isParent) {
  ...
  Interpreter.prototype.update = function (state, _event) {
    ...
    if (this.state.done) {
      ...
      this._doneEvent = (0, _actions.doneInvoke)(this.id, doneData);
      try {
  ...
  Interpreter.prototype.stop = function () {
    ...
    scheduler.schedule(function () {
      ...
      var nextState = (0, _serviceScope.provide)(_this, function () {
        ...
        var _a = (0, _tslib.__read)((0, _actions.resolveActions)(_this.machine, _this.state, _this.state.context, _event, [{
            type: 'exit',
            actions: exitActions
        ...
        var newState = new _State.State({
          ...
          actions: resolvedActions.filter(function (action) {
            return !(0, _utils.isRaisableAction)(action);
          }),
          activities: {},
          events: [],
          configuration: [],
...
function () {
  ...
  StateNode.prototype.next = function (state, _event) {
    ...
    return {
      transitions: [selectedTransition],
      exitSet: isInternal ? [] : (0, _utils.flatten)(nextStateNodes.map(function (targetNode) {
  ...
  StateNode.prototype.getActions = function (resolvedConfig, isDone, transition, currentContext, _event, prevState, predictableExec) {
    var e_4, _a, e_5, _b;
    var _this = this;
    var prevConfig = prevState ? (0, _stateUtils.getConfiguration)([], this.getStateNodes(prevState.value)) : [];
    var entrySet = new Set();
    try {
      for (var _c = (0, _tslib.__values)(Array.from(resolvedConfig).sort(function (a, b) {
          return a.order - b.order;
        })), _d = _c.next(); !_d.done; _d = _c.next()) {
        var sn = _d.value;
        if (!(0, _stateUtils.has)(prevConfig, sn) || (0, _stateUtils.has)(transition.exitSet, sn) || sn.parent && entrySet.has(sn.parent)) {
          entrySet.add(sn);
        }
      }
    } catch (e_4_1) {
    ...
    var doneEvents = (0, _utils.flatten)(entryStates.map(function (sn) {
      var events = [];
      if (sn.type !== 'final') {
        return events;
      }
    ...
    var entryActions = entryStates.map(function (stateNode) {
      ...
      return {
        type: 'entry',
        actions: (0, _actions.toActionObjects)(predictableExec ? (0, _tslib.__spreadArray)((0, _tslib.__spreadArray)([], (0, _tslib.__read)(entryActions), false), (0, _tslib.__read)(invokeActions), false) : (0, _tslib.__spreadArray)((0, _tslib.__spreadArray)([], (0, _tslib.__read)(invokeActions), false), (0, _tslib.__read)(entryActions), false), _this.machine.options.actions)
      };
    }).concat({
      type: 'state_done',
      actions: doneEvents.map(function (event) {
        return (0, _actions.raise)(event);
      })
    });
    var exitActions = Array.from(exitStates).map(function (stateNode) {
      return {
        type: 'exit',
        actions: (0, _actions.toActionObjects)((0, _tslib.__spreadArray)((0, _tslib.__spreadArray)([], (0, _tslib.__read)(stateNode.onExit), false), (0, _tslib.__read)(stateNode.activities.map(function (activity) {
    ...
    var actions = exitActions.concat({
      type: 'transition',
      actions: (0, _actions.toActionObjects)(transition.actions, this.machine.options.actions)
    }).concat(entryActions);
    if (isDone) {
  ...
  StateNode.prototype.resolveTransition = function (stateTransition, currentState, context, predictableExec, _event) {
    ...
    try {
      for (var actionBlocks_1 = (0, _tslib.__values)(actionBlocks), actionBlocks_1_1 = actionBlocks_1.next(); !actionBlocks_1_1.done; actionBlocks_1_1 = actionBlocks_1.next()) {
        var block = actionBlocks_1_1.value;
        try {
          for (var _c = (e_7 = void 0, (0, _tslib.__values)(block.actions)), _d = _c.next(); !_d.done; _d = _c.next()) {
            var action = _d.value;
    ...
    var _e = (0, _tslib.__read)((0, _actions.resolveActions)(this, currentState, context, _event, actionBlocks, predictableExec, this.machine.config.predictableActionArguments || this.machine.config.preserveActionOrder), 2),
      resolvedActions = _e[0],
      updatedContext = _e[1];
    var _f = (0, _tslib.__read)((0, _utils.partition)(resolvedActions, _utils.isRaisableAction), 2),
      raisedEvents = _f[0],
...
function createMachine(config, options) {
  if (!_environment.IS_PRODUCTION && !('predictableActionArguments' in config) && !warned) {
    warned = true;
...
exports.sendUpdate = exports.sendTo = exports.sendParent = exports.send = exports.raise = void 0;
...
exports.cascadingSelectControlsMachine = (0, xstate_1.createMachine)({
...
},{"xstate":"node_modules/xstate/es/index.js"}],"node_modules/rxjs/node_modules/tslib/tslib.es6.js":[function(require,module,exports) {
"use strict";
...
},{"tslib":"node_modules/rxjs/node_modules/tslib/tslib.es6.js","./AsyncAction":"node_modules/rxjs/_esm5/internal/scheduler/AsyncAction.js","./AsyncScheduler":"node_modules/rxjs/_esm5/internal/scheduler/AsyncScheduler.js"}],"node_modules/rxjs/_esm5/internal/util/noop.js":[function(require,module,exports) {
"use strict";
...
},{"tslib":"node_modules/rxjs/node_modules/tslib/tslib.es6.js","../Subscriber":"node_modules/rxjs/_esm5/internal/Subscriber.js"}],"node_modules/rxjs/_esm5/internal/observable/partition.js":[function(require,module,exports) {
"use strict";
...
},{"tslib":"node_modules/rxjs/node_modules/tslib/tslib.es6.js","../innerSubscribe":"node_modules/rxjs/_esm5/internal/innerSubscribe.js"}],"node_modules/rxjs/_esm5/internal/operators/auditTime.js":[function(require,module,exports) {
"use strict";
...
},{"tslib":"node_modules/rxjs/node_modules/tslib/tslib.es6.js","../innerSubscribe":"node_modules/rxjs/_esm5/internal/innerSubscribe.js"}],"node_modules/rxjs/_esm5/internal/operators/bufferCount.js":[function(require,module,exports) {
"use strict";
...
},{"tslib":"node_modules/rxjs/node_modules/tslib/tslib.es6.js","../Subscription":"node_modules/rxjs/_esm5/internal/Subscription.js","../innerSubscribe":"node_modules/rxjs/_esm5/internal/innerSubscribe.js"}],"node_modules/rxjs/_esm5/internal/operators/catchError.js":[function(require,module,exports) {
"use strict";
...
},{"tslib":"node_modules/rxjs/node_modules/tslib/tslib.es6.js","../innerSubscribe":"node_modules/rxjs/_esm5/internal/innerSubscribe.js"}],"node_modules/rxjs/_esm5/internal/operators/combineAll.js":[function(require,module,exports) {
"use strict";
...
},{"tslib":"node_modules/rxjs/node_modules/tslib/tslib.es6.js","../innerSubscribe":"node_modules/rxjs/_esm5/internal/innerSubscribe.js"}],"node_modules/rxjs/_esm5/internal/operators/debounceTime.js":[function(require,module,exports) {
"use strict";
...
},{"tslib":"node_modules/rxjs/node_modules/tslib/tslib.es6.js","../innerSubscribe":"node_modules/rxjs/_esm5/internal/innerSubscribe.js"}],"node_modules/rxjs/_esm5/internal/operators/distinctUntilChanged.js":[function(require,module,exports) {
"use strict";
...
},{"tslib":"node_modules/rxjs/node_modules/tslib/tslib.es6.js","../Subscriber":"node_modules/rxjs/_esm5/internal/Subscriber.js"}],"node_modules/rxjs/_esm5/internal/operators/distinctUntilKeyChanged.js":[function(require,module,exports) {
"use strict";
...
},{"tslib":"node_modules/rxjs/node_modules/tslib/tslib.es6.js","../util/EmptyError":"node_modules/rxjs/_esm5/internal/util/EmptyError.js","../Subscriber":"node_modules/rxjs/_esm5/internal/Subscriber.js"}],"node_modules/rxjs/_esm5/internal/operators/take.js":[function(require,module,exports) {
"use strict";
...
},{"tslib":"node_modules/rxjs/node_modules/tslib/tslib.es6.js","../innerSubscribe":"node_modules/rxjs/_esm5/internal/innerSubscribe.js"}],"node_modules/rxjs/_esm5/internal/operators/exhaustMap.js":[function(require,module,exports) {
"use strict";
...
},{"tslib":"node_modules/rxjs/node_modules/tslib/tslib.es6.js","../innerSubscribe":"node_modules/rxjs/_esm5/internal/innerSubscribe.js"}],"node_modules/rxjs/_esm5/internal/operators/finalize.js":[function(require,module,exports) {
"use strict";
...
},{"tslib":"node_modules/rxjs/node_modules/tslib/tslib.es6.js","../innerSubscribe":"node_modules/rxjs/_esm5/internal/innerSubscribe.js"}],"node_modules/rxjs/_esm5/internal/operators/min.js":[function(require,module,exports) {
"use strict";
...
},{"tslib":"node_modules/rxjs/node_modules/tslib/tslib.es6.js","../Subscriber":"node_modules/rxjs/_esm5/internal/Subscriber.js"}],"node_modules/rxjs/_esm5/internal/operators/partition.js":[function(require,module,exports) {
"use strict";
...
},{"tslib":"node_modules/rxjs/node_modules/tslib/tslib.es6.js","../Subject":"node_modules/rxjs/_esm5/internal/Subject.js","../innerSubscribe":"node_modules/rxjs/_esm5/internal/innerSubscribe.js"}],"node_modules/rxjs/_esm5/internal/operators/retry.js":[function(require,module,exports) {
"use strict";
...
},{"tslib":"node_modules/rxjs/node_modules/tslib/tslib.es6.js","../Subject":"node_modules/rxjs/_esm5/internal/Subject.js","../innerSubscribe":"node_modules/rxjs/_esm5/internal/innerSubscribe.js"}],"node_modules/rxjs/_esm5/internal/operators/sample.js":[function(require,module,exports) {
"use strict";
...
},{"tslib":"node_modules/rxjs/node_modules/tslib/tslib.es6.js","../innerSubscribe":"node_modules/rxjs/_esm5/internal/innerSubscribe.js"}],"node_modules/rxjs/_esm5/internal/operators/sampleTime.js":[function(require,module,exports) {
"use strict";
...
},{"tslib":"node_modules/rxjs/node_modules/tslib/tslib.es6.js","../Subscriber":"node_modules/rxjs/_esm5/internal/Subscriber.js"}],"node_modules/rxjs/_esm5/internal/operators/share.js":[function(require,module,exports) {
"use strict";
...
},{"tslib":"node_modules/rxjs/node_modules/tslib/tslib.es6.js","../innerSubscribe":"node_modules/rxjs/_esm5/internal/innerSubscribe.js"}],"node_modules/rxjs/_esm5/internal/operators/skipWhile.js":[function(require,module,exports) {
"use strict";
...
},{"tslib":"node_modules/rxjs/node_modules/tslib/tslib.es6.js","../innerSubscribe":"node_modules/rxjs/_esm5/internal/innerSubscribe.js"}],"node_modules/rxjs/_esm5/internal/operators/takeWhile.js":[function(require,module,exports) {
"use strict";
...
},{"tslib":"node_modules/rxjs/node_modules/tslib/tslib.es6.js","../innerSubscribe":"node_modules/rxjs/_esm5/internal/innerSubscribe.js"}],"node_modules/rxjs/_esm5/internal/operators/throttleTime.js":[function(require,module,exports) {
"use strict";
...
},{"tslib":"node_modules/rxjs/node_modules/tslib/tslib.es6.js","../Subject":"node_modules/rxjs/_esm5/internal/Subject.js","../innerSubscribe":"node_modules/rxjs/_esm5/internal/innerSubscribe.js"}],"node_modules/rxjs/_esm5/internal/operators/windowCount.js":[function(require,module,exports) {
"use strict";
...
require("./style.css");
var form_machine_host_1 = require("./form.machine-host");
var host = new form_machine_host_1.FormMachineHost();
host.currentState.subscribe(function (ctx) {
  return document.getElementById('state').innerHTML = JSON.stringify(ctx, null, 2);
});
host.context.subscribe(function (ctx) {
  return document.getElementById('context').innerHTML = JSON.stringify(ctx, null, 2);
});
host.state.subscribe(function (s) {
  return console.log(host.service.getSnapshot().nextEvents);
});
document.getElementById('first').addEventListener('click', function () {
  return host.firstSelected();
});
document.getElementById('second').addEventListener('click', function () {
  return host.secondSelected();
});
document.getElementById('third').addEventListener('click', function () {
  return host.thirdSelected();
});
document.getElementById('init').addEventListener('click', function () {
  return host.init();
});
},{"./style.css":"src/style.css","./form.machine-host":"src/form.machine-host.ts"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
